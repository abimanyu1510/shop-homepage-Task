...
function Card({cart,serCart,data}) {
                    ...
                    <div className="col mb-5">
                        <div className="card h-100">
                            ...
                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div className="text-center">
                                    {
                                    toggle?<button className="btn btn-outline-dark mt-auto" onClick={()=>{serCart(cart+1)
                                    setToggle(false)}}>
                                        Add to cart
                                        </button>:
                                        <button className="btn btn-outline-dark mt-auto" onClick={()=>{serCart(cart-1)
                                        setToggle(true)}}>
                                       Remove to cart
                                        </button>
                                    }
